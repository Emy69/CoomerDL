...
class Jpg5Adapter:
    ...
    def resolve_gallery(self, url):
        self.log("Processing JPG5 gallery: {url}", url=url)
        ...
        for div in divs:
            ...
            for enlace in enlaces:
                ...
                try:
                    ...
                    self.log("Error processing JPG5 media page {url}: {error}", url=media_page_url, error=e)
